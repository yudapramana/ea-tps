...
var RoleService = /*#__PURE__*/function () {
  ...
  _createClass(RoleService, [{
    ...
    value: function getRoles() {
      return axios__WEBPACK_IMPORTED_MODULE_1__["default"].get('/api/role', {
    ...
    value: function _delete(id) {
      return axios__WEBPACK_IMPORTED_MODULE_1__["default"]["delete"]("api/role/" + id, {
        headers: (0,_auth_header__WEBPACK_IMPORTED_MODULE_0__["default"])()
      }).then(function (response) {
...
var UserRoleService = /*#__PURE__*/function () {
  ...
  _createClass(UserRoleService, [{
    key: "get",
    value: function get() {
      return axios__WEBPACK_IMPORTED_MODULE_1__["default"].get('/api/user-role', {
        headers: (0,_auth_header__WEBPACK_IMPORTED_MODULE_0__["default"])()
      }).then(function (response) {
        console.log('response');
        console.log(response);
    ...
    key: "delete",
    value: function _delete(id) {
      return axios__WEBPACK_IMPORTED_MODULE_1__["default"]["delete"]("api/user-role/" + id).then(function (response) {
        console.log('response deleteRole');
        console.log(response);
        return response;
      });
    ...
    value: function getPermission() {
      return axios__WEBPACK_IMPORTED_MODULE_1__["default"].get('/api/get-permission', {
        headers: (0,_auth_header__WEBPACK_IMPORTED_MODULE_0__["default"])()
      }).then(function (response) {
        console.log('response');
        console.log(response);
