                                        ...
                                        <table class="table">
                                            ...
                                            <tbody>
                                                <tr v-for="item in levels" :key="item.id">
                                                    <td>{{ item.name }}</td>
                                                    <td>
                                                        <span v-for="(data, key) in item.role_permissions" :key="key">
                                                            {{ data }}
                                                            <!-- <br />
                                                            key: {{ key }} <br />
                                                            length: {{ item.role_permissions.length }} -->
                                                            <br v-if="item.role_permissions.length - 1 != key" />
                                                            <br v-if="item.role_permissions.length - 1 != key" />
                                                        </span>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="form-check col-sm-6" v-for="perm in permission.menu" :key="perm.id">
                                                <input class="form-check-input" type="checkbox" id="permissions"
                                                    name="permissions[]" :value="perm.id" v-model="form.permission_ids">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-check col-sm-6" v-for="perm in permission.page" :key="perm.id">
                                                <input class="form-check-input" type="checkbox" id="permissions"
                                                    name="permissions[]" :value="perm.id" v-model="form.permission_ids">
                                                <label class="form-check-label">{{ perm.name }}</label>
                                            </div>
...
export default {
    ...
    methods: {
        loadPermission(){
            UserRoleService.getPermission().then(
                (response) => {
        ...
        showModalEdit(item) {
            ...
            let parsedPermissionIds = JSON.parse(item.permission_ids);
